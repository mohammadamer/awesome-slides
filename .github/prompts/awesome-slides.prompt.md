---
agent: agent
argument-hint: Optionally specify variations of the presentation style (e.g. "Make it more playful", "I want a techy vibe", "Can you show me some options?"). If the user is unsure, guide them through the style discovery process by asking about the mood/feeling they want to convey, then generate 3 distinct style previews for them to choose from.
---
...
Create the previews in: `.design/slide-previews/`

```
.design/slide-previews/
...
- .design/slide-previews/style-a.html
- .design/slide-previews/style-b.html
- .design/slide-previews/style-c.html
...
1. **Clean up temporary files**
   - Delete `.design/slide-previews/` if it exists
